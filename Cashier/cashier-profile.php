      ...
      <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
          ...
          <ul id="tables-nav" class="nav-content collapse show " data-bs-parent="#sidebar-nav">
            <li>
              <a href="cashier-payment-list.php" class="active">
        ...
        <li class="nav-item">
          <a class="nav-link collapsed" href="cashier-profile.php">
            <i class="bi bi-person"></i>
            <span>Profile</span>
          </a>
          ...
          <div class="tab-content pt-2">
            ...
            <div class="tab-pane fade show active profile-overview" id="profile-overview">
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-8">Panabo City Diagnostic Center</div>
              </div>
            ...
            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
              ...
              <form>
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <input name="job" type="text" class="form-control" id="Job" value="Cashier">
                  </div>
                </div>
